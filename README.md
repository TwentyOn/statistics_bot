...
Результатом работы бота является xlsx-файл со стастикой трафика по каждому из принятых url-адресов
...
- Запуск: ```<имя_окружения>/Scripts/activate``` (win)

# Установка необходимых библиотек
Необходиые библиотеки представлены в файле requirements.txt. Для установки требуется
